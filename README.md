...
- Sidebar:
  - Live count of hwow many cells in total are alive.
  - List of species alive followed by their amount of alive individuals.
    - You can interact with a specie by right clicking on it on this menu.
...
### Huge thanks to:
- Carhky for the inspiration;
- Stefan Gustavson, Peter Eastman and Joseph Gentle por Perlin Noise;
- Daniel Shiffman from Coding Train for his admirable didatics;
- The long ones gone who somehow contributed to my existence.
